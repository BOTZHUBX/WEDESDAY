class script(object):   
    ...
    ABOUT_TXT = """× ᴍʏ ɴᴀᴍᴇ: {}
× ᴍʏ ᴄʀᴇᴀᴛᴏʀ: <a href=https://t.me/xenxd>ᴍɪᴋᴇʏ sᴀᴍᴀ</a>
× ʟɪʙʀᴀʀʏ: ᴘʏʀᴏɢʀᴀᴍ
× ʟᴀɴɢᴜᴀɢᴇ:  ᴘʏᴛʜᴏɴ 𝟹
× ᴅᴀᴛᴀ ʙᴀsᴇ: ᴍᴀɴɢᴏ ᴅʙ
× ʙᴏᴛ sᴇʀᴠᴇʀ: ʜᴇʀᴏᴋᴜ
...
× ᴄʜᴇᴄᴋ ᴏᴜᴛ ᴏᴜʀ ᴀʟʟ ᴄʜᴀɴɴᴇʟꜱ - @wizards_network
...
𝙲𝚁𝙴𝙳𝙸𝚃𝚂 :- <a href=https://t.me/xenxd>mikey sama</a>**"""
...
𝖬𝖺𝖽𝖾 𝖻𝗒 <a href=https://t.me/xenxd>mikey sama</a>"""
