...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[           
            InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ', url=f'https://t.me/{SUPPORT_CHAT}')
            ],[
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton("ᴜᴘᴅᴀᴛᴇs", url="https://t.me/team_netflix")
            ],[      
        ...
        m=await message.reply_sticker("CAACAgUAAxkBAAEQqd1kQj1WFHGQNri__SUP9yxEQMFnfwACLwkAAgkAAYlWR0Qtzs9OLr0vBA")
